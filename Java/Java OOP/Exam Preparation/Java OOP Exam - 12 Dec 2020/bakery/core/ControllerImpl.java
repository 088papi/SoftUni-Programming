...
public class ControllerImpl implements Controller {
    private FoodRepository<BakedFood> bakedFoodFoodRepository;
    private DrinkRepository<Drink> drinkRepository;
    private TableRepository<Table> tableRepository;
    private double totalIncome;

    public ControllerImpl(FoodRepository<BakedFood> foodRepository, DrinkRepository<Drink> drinkRepository, TableRepository<Table> tableRepository) {
        this.bakedFoodFoodRepository = foodRepository;
    ...
    public String addFood(String type, String name, double price) {
        BakedFood food = this.bakedFoodFoodRepository.getByName(name);
        if (food != null) {
        ...
        this.bakedFoodFoodRepository.add(food);
    ...
    public String orderFood(int tableNumber, String foodName) {
        ...
        BakedFood food = this.bakedFoodFoodRepository.getByName(foodName);
        if (food == null) {
    ...
    public String getFreeTablesInfo() {
        ...
        for (Table table : this.tableRepository.getAll()) {
            if (!table.isReserved()){
                stringBuilder.append(table.getFreeTableInfo())
