...
public abstract class BaseComputer extends BaseProduct implements Computer {
    ...
    public double getPrice() {
        ...
        return super.getPrice() + components
                .stream().mapToDouble(Component::getPrice).sum() +
                peripherals
                        .stream().mapToDouble(Peripheral::getPrice).sum();
    }
    ...
    public String toString() {
        ...
        sb.append(String.format(" " + COMPUTER_PERIPHERALS_TO_STRING, peripherals.size(), peripherals.stream().
